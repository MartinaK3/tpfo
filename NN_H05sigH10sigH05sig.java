 ...
 */
public class NN_H05sigH10sigH05sig extends NN {

    public NN_H05sigH10sigH05sig(int inputSize, int outputSize) {
        ...
        net.addLayer(new BasicLayer(sigmoid, true, (int) (inputSize*1.0)));
        net.addLayer(new BasicLayer(sigmoid, true, (int) (inputSize*0.5)));
        // ouput layer 
