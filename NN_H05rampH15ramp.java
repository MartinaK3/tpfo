 ...
 * @author Fatima
 */
public class NN_H05rampH15ramp extends NN {
    public NN_H05rampH15ramp(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(ramp, true, (int) (inputSize * 0.5)));
        net.addLayer(new BasicLayer(ramp, true, (int) (inputSize * 1.5)));
        // ouput layer 
