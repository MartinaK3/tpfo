 ...
 */
public class NN_H50sigH15sigH20sig extends NN {

    public NN_H50sigH15sigH20sig(int inputSize, int outputSize) {
        ...
        net.addLayer(new BasicLayer(sigmoid, true, (int) (inputSize*2)));
        // ouput layer 
