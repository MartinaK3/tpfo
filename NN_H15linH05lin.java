 ...
 */
public class NN_H15linH05lin extends NN {

    public NN_H15linH05lin(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(linear, true, (int) (inputSize * 1.5)));
        net.addLayer(new BasicLayer(linear, true, (int) (inputSize*0.5)));
        // ouput layer 
