 ...
 */
public class NN_H50softH05soft extends NN {

    public NN_H50softH05soft(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(softmax, true, (int) (inputSize * 5)));
        net.addLayer(new BasicLayer(softmax, true, (int) (inputSize*0.5)));
        // ouput layer 
